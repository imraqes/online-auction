<%-- 
    Document   : profile
    Created on : Jan 21, 2015, 10:18:49 PM
    Author     : Raqesh Chand
--%>
                ...
                <div class="contact_top">
                    <div class="container">
                        <div class="col-md-6 contact_left wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            <h4><input type="button" value="Registered Products" onclick="window.location.href = 'regprod.jsp'"></h4>
                            <br><br>
                            <h4><input type="button" value="Your Bids" onclick="window.location.href = 'bidprod.jsp'"></h4>
                            <br><br>
                            <h4><input type="button" value="Change Password" onclick="window.location.href = 'changepassword.jsp'"></h4>
                        </div>
