<%-- 
    Document   : searchbycat
    Created on : Mar 31, 2015, 2:02:55 PM
    Author     : Rakesh Chand
--%>
<%
        ...
        <script>
            function validate(){
                if(document.searchForm.category.value == ""){
                    alert("select one of the category");
                ...
                <div class="login-page">
                    ...
                    <div class="account_grid">
                        ...
                        <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
                            ...
                            <form action="catprod.jsp" method="post" name="searchForm" onsubmit="return(validate());">
                                <div>
