<%-- 
    Document   : bikes
    Created on : Mar 31, 2015, 12:16:16 PM
    Author     : Rakesh Chand
--%>
    ...
    <body>
        ...
        <div class="header">
            ...
            <ul class="breadcrumbs">
                <li class="home">
                    <a href="index.jsp" title="Go to Home Page">Home>Products by CATEGORY</a>&nbsp;
                    <span>&gt;</span>
                </li>
                <li class="women">
              BIKES
...
<%
    ...
    c.add(Restrictions.eq("category", "bikes"));
                ...
                <div class="container">
                    <div class="Popular-Restaurants-grid wow fadeInRight" data-wow-delay="0.4s">
                        ...
                        <div class="col-md-7 buy">
                            ...
                            <input type="button" value="Bid" onclick="window.location.href='Bid.jsp?id=<%=id%>&title=<%=title%>&details=<%=details%>&quantity=<%=quantity%>&price=<%=price%>&increment=<%=increment%>&image=<%=image%>&closingdate=<%=closingdate%>&registereddate=<%=currentdate%>'" >
