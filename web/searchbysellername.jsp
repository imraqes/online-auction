<%-- 
    Document   : searchbysellername
    Created on : Mar 31, 2015, 2:04:13 PM
    Author     : Rakesh Chand
--%>
<%
...
<html>
    <head>
        <script>
            function validate() {
                if (document.searchForm.seller.value == "") {
                    alert("Enter seller name");
                    document.searchForm.seller.focus();
                    return false;
                }
                ...
                <div class="login-page">
                    ...
                    <div class="account_grid">
                        <div class="col-md-6 login-left wow fadeInLeft" data-wow-delay="0.4s">
                            ...
                            <a class="acount-btn" href="searchbyproname.jsp">SEARCH BY PRODUCT NAME</a>

                        </div>
                        <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
                            <h3>SEARCH BY SELLER NAME</h3>


                            <form action="prodseller1.jsp" method="post" name="searchForm" onsubmit="return(validate());">
                                <div>
                                    <span>SELLER NAME<label>*</label></span>
                                    <input type="text" name="seller" placeholder="Enter seller's user name" required> 
                                </div>
